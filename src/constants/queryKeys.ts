export const queryKeys = {
  ...
  contents: {
    ...
    like: (contentId: number | undefined) => ["contents", contentId, "like"] as const,
    likes: (contentIds: number[]) => ["contents", "likes", contentIds] as const,
  },
  reviews: {
    ...
    byUser: (userId: number | undefined) => ["reviews", "users", userId] as const,
  },
} as const;
