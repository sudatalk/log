...
const WriteReviewButton = (props: Props) => {
  ...
  return (
    <div className={clsx(FLEX, W_FULL, CENTER, GAP_5)}>
      <Button className={clsx("h-10 p-6 bg-[#333333] w-40", ROUNDED)} size="lg" disabled={disabled}>
        <span className={clsx(TEXT_XL)}>임시저장</span>
      </Button>
      <Button className={clsx("h-10 p-6 bg-[#348352] w-40", ROUNDED)} size="lg" disabled={disabled}>
